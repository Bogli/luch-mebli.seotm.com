    ...
    */
    ...
    if( $this->id!=NULL )
     ...
     while( $el = each( $this->ln_arr ) )
     {
         ...
         $this->Form->SpecialTextArea(NULL, 'short['.$lang_id.']', stripslashes($val), 12, 70, NULL, $lang_id, 'short' );
         echo "\n <br>";

         if($this->settings['set_full']==1){
            echo "\n <tr>";
            ...
            $this->Form->SpecialTextArea(NULL, 'full['.$lang_id.']', stripslashes($val), 25, 70, NULL, $lang_id, 'full' );
            echo "\n <br>";
         }
         echo   "\n </table>";
