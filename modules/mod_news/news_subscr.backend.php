...
$News = new NewsCtrl($pg->logon->user_id, $module, 10, $sort, $start, '100%');
$News->module = $module;
...
$News->sort = $sort;
$News->fltr = $fltr;
$News->user_status = $user_status;
$News->login = strip_tags(trim($login));
$News->pass = strip_tags(trim($pass));
$News->dt = strip_tags(trim($dt));
$News->is_send = $is_send;
